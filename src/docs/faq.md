...
H系模组都存在一个角色分配失败的Bug，原生 TOH 出现该Bug的时候房主会看不到开始按钮，其它玩家则会无限黑屏加载，遇到这种情况只能所有人退出游戏。而在 TOHE 里，为了避免这种情况，会自动检测其他玩家是否卡在加载，如果检测到则会自动终止游戏以防止所有人卡死。所以这是一种保护机制，无视并继续游玩即可。
